...
<?php 
	...
	if ($c > 0) {
		...
		echo "<table style='margin-top:30px; margin-left:20px;'><tr class='adM' style='font-size: 25px;'>
  ...
  // output data of each row
				...
				
	{
		...
		for($i = 1;$i<=$m;$i+=$c){
			...
			echo  "<tr class='bz' style='text-align:center;'><td>".++$g."</td><td>".$date["date"]. "</td>";
			$k = 1;
			for($j=$i;$j<=($i+$c-1);$j++){
	...
	echo "<p class='adM' style='font-size: 25px; padding: 10px;'>CURRENT MEAL RATE:   " .$rmr."</p><br>";
